...
*`}}}})),c,l,u,d,f,p,m;e((()=>{s(),c={title:`UI/labels/MyLabel`,component:i,tags:[`autodocs`],parameters:{layout:`centered`},argTypes:{size:{control:`inline-radio`,options:[`normal`,`h1`,`h2`,`h3`]},color:{control:`inline-radio`,options:[`text-primary`,`text-secondary`,`text-tertiary`]},backgroundColor:{control:`color`}}},l={args:{label:`Basic Label`}},u={args:{label:`All Caps Label`,allCaps:!0}},d={args:{label:`Secondary Label`,color:`text-secondary`}},f={args:{label:`Tertiary Label`,color:`text-tertiary`}},p={args:{label:`BackgroundColor Label`,backgroundColor:`#fc0a0a`}},l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:`{
  args: {
    label: "Basic Label"
  }
...
}`,...p.parameters?.docs?.source}}},m=[`Basic`,`AllCaps`,`Secondary`,`Tertiary`,`BackgroundColor`]}))();export{u as AllCaps,p as BackgroundColor,l as Basic,d as Secondary,f as Tertiary,m as __namedExportsOrder,c as default};