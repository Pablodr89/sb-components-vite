import{n as e}from"./chunk-BneVvdWh.js";import{t}from"./jsx-runtime-6sF1Ejqi.js";import{t as n}from"./compiler-runtime-yzUrkN5I.js";var r=e((()=>{}));function i(e){let t=(0,a.c)(9),{label:n,size:r,allCaps:i,color:s,fontColor:c}=e,l=r===void 0?`normal`:r,u=i===void 0?!1:i,d=`${l} ${s} label`,f;t[0]===c?f=t[1]:(f={color:c},t[0]=c,t[1]=f);let p;t[2]!==u||t[3]!==n?(p=u?n.toUpperCase():n,t[2]=u,t[3]=n,t[4]=p):p=t[4];let m;return t[5]!==d||t[6]!==f||t[7]!==p?(m=(0,o.jsx)(`span`,{className:d,style:f,children:p}),t[5]=d,t[6]=f,t[7]=p,t[8]=m):m=t[8],m}var a,o,s=e((()=>{a=n(),r(),o=t(),i.__docgenInfo={description:``,methods:[],displayName:`MyLabel`,props:{label:{required:!0,tsType:{name:`string`},description:`Text to be displayed in the label\r
...
*`},fontColor:{required:!1,tsType:{name:`string`},description:`Color of the label text with custom value\r
*`}}}})),c,l,u,d,f,p;e((()=>{s(),c={title:`UI/labels/MyLabel`,component:i,tags:[`autodocs`],parameters:{layout:`centered`},argTypes:{size:{control:`inline-radio`,options:[`normal`,`h1`,`h2`,`h3`]},color:{control:`inline-radio`,options:[`text-primary`,`text-secondary`,`text-tertiary`]},fontColor:{control:`color`}}},l={args:{label:`Basic Label`}},u={args:{label:`All Caps Label`,allCaps:!0}},d={args:{label:`Secondary Label`,color:`text-secondary`}},f={args:{label:`Custom Color Label`,fontColor:`#FF5733`}},l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:`{
  args: {
    label: "Basic Label"
  }
